...
function resume_skill_array($language){
    ...
    // $skill_id_array = App\Resume_skill::where('language', $language)->get()->lists('id')->toArray();
    // // $skill_array_value = array_values($skill_array);
    // // $skill_array_value = array_column($skill_array, 'id', 'language');

    // $skill_category_array = App\Resume_skill::where('language', $language)->get()->lists('category')->toArray();
...
function get_language_ids($language){
    $ids = App\Resume_skill::where('language', $language)->lists('id')->toArray();
    return $ids;
}
